    ...
    _postprocess : function(rootJsdocNode, ctx) {
        var _this = this,
            postprocessCb = function(jsdocNode) {
                _this._postprocess(jsdocNode, ctx);
            };
        this.iterate(rootJsdocNode, function(jsdocNode) {
            this._postprocessByType(jsdocNode.jsdocType, jsdocNode, ctx, postprocessCb);
            this._postprocessByType('', jsdocNode, ctx, postprocessCb);
        }, this);
    },
