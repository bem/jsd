...
JSDoc.prototype = {
    ...
    registerTagParser : function(tagName, parseFn) {
        this._tagParsers[tagName] = parseFn;
        return this;
    },
            ...
            function(astNode, jsdocNode) {
                ...
                if(astNode.comments) {
                    ...
                    tags.forEach(function(tag) {
                        _this._tagBuilders[tag.type] && _this._tagBuilders[tag.type].forEach(function(builder) {
    ...
    _parseTagComment : function(tagType, comment) {
        var parse = this._tagParsers[tagType];
        if(!parse) {
