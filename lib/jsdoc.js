...
module.exports = inherit({
    ...
    registerTagsStartBuilder : function(builder) {
        this._tagsBuilders.start.push(builder);
        return this;
    },

    registerTagsEndBuilder : function(builder) {
        this._tagsBuilders.end.push(builder);
        return this;
    },
        ...
        sourceTree.iterate(
            function(astNode, jsdocNode) {
                ...
                if(astNode.comments) {
                    ...
                    _this._tagsBuilders.start.forEach(function(builder) {
                    ...
                    _this._tagsBuilders.end.forEach(function(builder) {
                        var res = builder.call(ctx, tags, accJsdocNode, astNode);
                        typeof res !== 'undefined' && (accJsdocNode = res);
                    });
                }
